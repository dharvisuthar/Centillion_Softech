...
import "../../style.css";
import {  FaCss3, FaNodeJs, FaHtml5, FaAngular, FaCode, FaReact, FaPhp, FaDatabase, FaJava, FaAws, FaApple, FaAndroid, FaVuejs, FaThLarge, FaPython} from 'react-icons/fa';
/**
    ...
    render() {
        ...
        return (
            <div className={classes.main_div}>
                ...
                {/* portfolio first div */}
                <Grid>
                    <Grid item xs={12} className={classes.header_cardMedia_portfolio} >
