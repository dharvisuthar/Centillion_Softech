                ...
                <div className={classes.main_div}>
                    ...
                    <Grid container spacing={24} className={classes.footer_seconddiv_padding}>
                        ...
                        <Grid item xs={12} sm={12} md={9} lg={9} className="col-privacy-policy">
                            ...
                            <p className="p-privacy-policy"><span className="font-weight-600">By email: </span><a className="link-privacy-policy"></a></p>
                            <p className="p-privacy-policy"><span className="font-weight-600">By phone number: </span><a className="link-privacy-policy">{phoneNumber}</a></p>   </Grid>
                    </Grid>
                </div>
            </div>
        );
