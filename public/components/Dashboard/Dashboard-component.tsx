      ...
      <div className={classes.main_div}>
        ...
        <div className="bg-2a2f35">
          <Grid container className="container-div-tab" >
            <CarouselHeader defaultWait={10000} /*wait for 1000 milliseconds*/ >
              <Slide right>
                <div>
          ...
          <Grid container spacing={24} className="main-container-div padding-bottom-50">
            ...
            <Grid item xs={12} sm={12} lg={4} md={4} className="grid-dash-second-main-paper">
              <CardMedia image={fitnessImage} className="image-perfect"> </CardMedia>
              <div className="image-perfect-div">
                <a href="http://www.7wfitness.com/#/" target="_blank"> <Add className="perfect-image-div" /> </a>
              </div>
            ...
            <Grid item xs={12} sm={12} lg={4} md={4} className="grid-dash-second-main-paper">
              <CardMedia image={etruckingImage} className="image-perfect"> </CardMedia>
              <div className="image-perfect-div">
                <a href="http://52.34.154.149:7000/#/" target="_blank"> <Add className="perfect-image-div" /> </a>
              </div>
